...
public class VoiceExtractor implements SoundExtractor<Sound, Sound>{
	...
	public Sound extract(Sound sound) throws Exception{
		if(sound == null) throw new NullPointerException("sound cannot be null");
		else if(sound.samplesLength() <= 0) throw new IllegalArgumentException("sound length must be greater than 0");
