...
public class Spectra {
	...
	public static int getIndex(Spectra spectra, double frequency){
		if(frequency < spectra.getLowestFrequency()) throw new IllegalArgumentException("you can't get amplitude from frequency lower than nyquist frequency");
		else if(frequency > spectra.getHighestFrequency()) throw new IllegalArgumentException("you can't get amplitude from frequency higher than nyquist frequency");
