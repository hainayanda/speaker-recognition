...
public class Complex {
    ...
    private static Complex exp(Complex x) {
        return new Complex((double)(Math.exp(x.real) * Math.cos(x.imaginary)), (double)(Math.exp(x.real) * Math.sin(x.imaginary)));
    }
    ...
    private static Complex sin(Complex x) {
        return new Complex((double)(Math.sin(x.real) * Math.cosh(x.imaginary)), (double)(Math.cos(x.real) * Math.sinh(x.imaginary)));
    }
    ...
    private static Complex cos(Complex x) {
        return new Complex((double)(Math.cos(x.real) * Math.cosh(x.imaginary)), (double)(-Math.sin(x.real) * Math.sinh(x.imaginary)));
    }
